                ...
                buttons[i][j].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (((Button) v).getText().toString().equals("")) { // Check if button is empty
                            ...
                            Toast.makeText(MainActivity.this, "This spot is already taken!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void showQuizDialog(Button button) {
        ...
        final CountDownTimer timer = new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(MainActivity.this, "Time's up! Turn skipped.", Toast.LENGTH_SHORT).show();
                togglePlayer();
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (selectedId != -1) {
                    ...
                    if (selectedAnswer.equals(question.getCorrectAnswer())) {
                        ...
                        Toast.makeText(MainActivity.this, "Incorrect! Turn skipped.", Toast.LENGTH_SHORT).show();
                        togglePlayer();
                    }
                }
                timerTextView.setText("");
